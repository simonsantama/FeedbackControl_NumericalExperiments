"""
This script uses a PID controller to maintain the surface temperature at a constant value.
...
surface_temperature_setpoint = 588     # K
        ...
        for alpha_number in range(len(alphas)):
            ...
            for time_step,t in enumerate(t_grids[alpha_number][:-maximum_limit_tgrid]):
                ...
                if time_lag_counter < number_timereadings[alpha_number]:
                    ...
                    # call PID
                    new_q, new_error, error_sum = PID(surface_temperature, surface_temperature_setpoint, last_error, 
                                                      last_surface_temperature, error_sum, timeChange,kp[alpha_number],
...
#                    print(f"Current surface temperature: {surface_temperature_array[time_step]}")
